...
class Handler(Plugin):
    ...
    def commands(self, subparsers):
        ...
        file_process_parser.add_argument("--emails", action="store_true", help="Extract emails from the file (supports PDF, DOCX, DOC, TXT)")
        file_process_parser.add_argument("--pdfs", action="store_true", help="Extract and print text from documents (PDF, DOCX, DOC)")
        file_process_parser.add_argument("--keywords", nargs="+", help="List of keywords to search for (supports PDF, DOCX, DOC, TXT)")
